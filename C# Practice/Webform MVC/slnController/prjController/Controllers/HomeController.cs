...
namespace prjController.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            string[] name = new string[] { "櫻桃鴨", "鴨油高麗菜", "麻婆豆腐", "櫻桃鴨握壽司", "片皮鴨捲三星蔥", "三杯鴨", "櫻桃鴨片肉", "白菜燉鴨湯" };
            string show = string.Format("<p align ='center'><img src = '../images/{0}.jpg'><br />{1}</p>", index, name[index]);
            return show;
        }
    }
}